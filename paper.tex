...
\articletype{RESEARCH ARTICLE PREPRINT (submitted May 2016)}
...
\corraddr{P.~Bachant, Chase Ocean Engineering Laboratory, University of New
Hampshire, 24 Colovos Rd., Durham, NH, 03824, USA. \\
E-mail: pwbachant@gmail.com}
...
The ASSM and ALM were implemented to model a very low Reynolds number (based on
...
al.~\cite{Brochier1986}. In this study we validated the ALM with experimental
data taken at Reynolds number two orders of magnitude higher, reporting its
performance predictions, neither of which have been done before. Additionally,
assessed the use of the ALM in more computationally affordable unsteady RANS
simulations, which also has not yet been reported for VATs.
...
against experimental data for the high solidity ($c/R=0.28$) UNH Reference
...
\cite{Bachant2016-RVAT-Re-dep} and \cite{Bachant2016-RM2-data}, respectively.
The turbines were modeled at $Re_D \sim 10^6$, at which experimentally measured
performance and near-wake characteristics were nearly Reynolds number
independent~\cite{Bachant2016-Energies,Bachant2016-RM2-paper}.
...
in the literature. Default Smagorinsky model coefficients were used, and the LES
filter width was set as the cube root of the local cell volume. The tip speed
ratio was set to oscillate sinusoidally about $\lambda_0$ with a 0.19 magnitude
and the angle of the first peak at 1.4 radians---similar to the rotation
presribed in the blade-resolved RANS simulations discussed in
\cite{Bachant2016-BR-CFD}.
