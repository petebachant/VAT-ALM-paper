...
\Author{
    Peter Bachant $^{1,\dagger,\ddagger}$\orcidA{},
    Anders Goude $^{2,\ddagger}$
    and Martin Wosnik $^{1,}$*
}
...
\corres{Correspondence: pwbachant@gmail.com}
...
\authorcontributions{
    ...
    M.W. contributed to writing and editing of the manuscript.
}
