...
frequencies at $\lambda_0$ are 0.27 and 0.17 (based on root chord length) for
...
\cite{Bachant2016-BR-CFD} to approximately (including blockage) the tow tank
...
\begin{figure}
    ...
    that increased mesh refinrement was used for the LES simulations.}
...
Figure~\ref{RVAT-ALM-LES-meancontquiv}. Compared with the RANS ALM results, the
LES looks much more like the blade-resolved and experimental results
