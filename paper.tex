...
in the literature. OpenFOAM's default Smagorinsky model coefficients were used
(giving an approximate equivalent Smagorinsky coefficient $C_S = 0.17$), and the
LES filter width was set as the cube root of the local cell volume. The tip
speed ratio was set to oscillate sinusoidally about $\lambda_0$ with a 0.19
